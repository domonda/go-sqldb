...
func Exec(ctx context.Context, conn QueryExec, query string, args ...any) error {
...
// with optional args.
func ExecStmt(ctx context.Context, conn QueryExec, query string) (execFunc func(ctx context.Context, args ...any) error, closeStmt func() error, err error) {
