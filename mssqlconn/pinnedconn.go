...
// Compile-time check that the mssqlconn connection implements [sqldb.ConnPinner].
...
// session-scoped state like sp_getapplock that must live and die on one session.
